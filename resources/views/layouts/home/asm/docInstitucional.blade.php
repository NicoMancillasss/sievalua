...
<h3 class="text-center m-5">Documento Institucional {{$evaluacion->ejercicio->año}}</h3>
<div class="card shadow m-3">
	...
	<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
		...
		<div class="dropdown no-arrow">
            <a href="{{route('pdf.docInstitucional',$evaluacion->ejercicio->id) }}" class="btn btn-danger btn-sm hvr-box-shadow-outset"><i class="fas fa-file-pdf"></i>     Pdf     </a>
