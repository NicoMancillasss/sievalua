                        ...
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 40px; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
                                   <strong>Se te ha realizado una observación</strong>
                                   <br>
                                   <br>
                                <strong>Observación: {{$mensaje->observacion}}</strong>
                                   <br>
                                   <br>
                                   <label for="">Verifica en tu cuenta de SIEVALUA tus mensajes a detalle y revisa la observación</label>
