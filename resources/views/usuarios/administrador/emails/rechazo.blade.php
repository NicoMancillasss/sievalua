                    ...
                    <td>
                        <table cellspacing="0" cellpadding="0" border="0" width="100%">
                            ...
                            <p align="justify" style="color: black;">
                                ...
                                evaluaciones del Programa Anual de Evaluación {{ $solicitud->ejercicio->año+1 }}.
                                <br>
                            ...
                            <table border="1">
                             ...
                             @foreach ($solicitud->postula->where('cita',Null)->where('lugar',Null)->where('estatus',0) as $postula)
                             <tr>
                         ...
                         <p align="justify">
                           <strong>{{$data->correcciones}}</strong>
                       </p>    
                       <tr>
                        <td>
