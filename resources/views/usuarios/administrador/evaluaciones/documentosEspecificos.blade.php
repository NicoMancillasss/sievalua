...
<div class="card shadow mb-4">
	...
	<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
		<h6 class="m-0 font-weight-bold text-dark">Documentos Específicos </h6>
	...
	<!-- Card Body -->
	<div class="card-body">
		<form method="POST" action="{{ route('evaluacion.documentos.especificos.guardar',[$ejercicio_id,$evaluacion]) }}">
					@csrf
					@method('POST')
					<h6>Catálogo de documentos Específicos</h6>
