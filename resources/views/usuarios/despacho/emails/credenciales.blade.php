            			...
            			<table cellspacing="0" cellpadding="0" border="0" width="100%">
            				<tr>
            					<td style="padding: 40px; font-family: sans-serif; font-size: 15px; mso-height-rule: exactly; line-height: 20px; color: #555555;">
            						<strong> Bienvenido al sistema SiEvalúa </strong>
            						<br>
            						Te enviamos tus credenciales de acceso al si evalúa.
            						<br />
            						<strong>Usuario: </strong>{{ $informacion['email']}}
            						<br/>
            						<strong>Contraseña:</strong>{{$informacion['password']}}
            						<br><br>
                                    <!-- Button : Begin 
