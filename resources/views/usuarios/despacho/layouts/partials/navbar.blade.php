...
<!-- Nav Item - Alerts -->
                    ...
                    @foreach (Auth::user()->unreadNotifications as $notification)
                        <a class="dropdown-item d-flex align-items-center" href="#">
                            ...
                            <div>
                                ...
                                <span class="font-weight-bold">{{ $notification->data['comment'] }}</span>
                            </div>
                        </a>
                    @endforeach--}}
			...
			<li class="nav-item dropdown">
				<a class="nav-link dropdown-toggle hvr-icon-grow" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
					<span class="mr-2 d-none d-lg-inline text-gray-600 small"><i class="fas fa-user fa-lg mr-2 hvr-icon"></i>  {{ Auth::user()->nombre }}</span>
