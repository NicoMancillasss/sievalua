...
<div class="card shadow mb-4">
	<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
		...
		<div class="dropdown no-arrow">
			<a href="{{ route('despacho.asm.recomendados',[Crypt::encrypt($postulacion->id)]) }}" class="btn btn-info btn-sm hvr-box-shadow-outset"><i class="fas fa-angle-left"></i>
                Regresar
            </a>
	...
	<!-- Card Body -->
	<div class="card-body">
		<form method="POST" action="{{ route('despacho.asm.guardar.despacho',[Crypt::encrypt($postulacion->id)]) }}">
			@csrf
			@method('POST')
		...
		<div class="form-group">
			<button type="submit" class="btn btn-block btn-primary mt-3 hvr-box-shadow-outset"> <i class="fas fa-save"></i> Guardar</button>
		</div>
